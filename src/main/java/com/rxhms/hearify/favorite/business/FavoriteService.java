...
public class FavoriteService {
    ...
    private static final String ALREADY_FAVORITE_MESSAGE = "The track with id {0} is already a favorite for the specified user";
    private static final String NOT_FAVORITE_MESSAGE = "The track with id {0} is not a favorite for the specified user";
