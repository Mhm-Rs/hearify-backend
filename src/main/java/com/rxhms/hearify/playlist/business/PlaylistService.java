...
public class PlaylistService {
    ...
    private static final String ALREADY_EXISTING_TRACK_MESSAGE = "The track with id {0} is already in the specified playlist.";
    private static final String ALREADY_EXISTING_PLAYLIST_MESSAGE = "This user already has a playlist with the name {0}";
    private static final String NOT_EXISTING_TRACK_MESSAGE = "The track with id {0} could not be found inside the specified playlist.";

    public Playlist getPlaylistById(Integer id) {
        return playlistRepository.findById(id).orElseThrow(() -> new HearifyNotFoundException(NOT_FOUND_MESSAGE, id));
    }
